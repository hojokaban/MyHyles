...
#麦わらの一味
zoro=luffy.hyles.create!(category: cate1,name: "ロロノア・ゾロ",birthday: Date.parse("1999-11-11"),birthday_date:"1111",total_relationship: 10,tag_list:["最悪の世代"])
nami=luffy.hyles.create!(category: cate1,name: "ナミ",birthday: Date.parse("2000-7-3"),birthday_date:"0703",total_relationship: 60)
usopp=luffy.hyles.create!(category: cate1,name: "ウソップ",birthday: Date.parse("1999-4-1"),birthday_date:"0401",total_relationship: 100)
sanji=luffy.hyles.create!(category: cate1,name: "ヴィンスモーク・サンジ",birthday: Date.parse("1999-3-2"),birthday_date:"0302",total_relationship: 120)
chopper=luffy.hyles.create!(category: cate1,name: "トニートニー・チョッパー",birthday: Date.parse("2003-12-24"),birthday_date:"1224",total_relationship: 10,tag_list:["能力者"])
robin=luffy.hyles.create!(category: cate1,name: "ニコ・ロビン",birthday: Date.parse("1990-2-6"),birthday_date:"0206",total_relationship: 106,tag_list:["能力者"])
franky=luffy.hyles.create!(category: cate1,name: "フランキー",birthday: Date.parse("1984-3-9"),birthday_date:"0309",total_relationship: 17)
brook=luffy.hyles.create!(category: cate1,name: "ブルック",birthday: Date.parse("1930-4-3"),birthday_date:"0403",total_relationship: 31,tag_list:["能力者"])
#ルフィの兄弟
ace=luffy.hyles.create!(category: cate2,name: "エース",birthday: Date.parse("1998-1-1"),birthday_date:"0101",total_relationship: 5,tag_list:["能力者","兄弟"])
sabo=luffy.hyles.create!(category: cate4,name: "サボ",birthday: Date.parse("1998-3-20"),birthday_date:"0320",total_relationship: 150,tag_list:["能力者","兄弟"])
#海軍
sengoku=luffy.hyles.create!(category: cate3,name: "センゴク",birthday: nil,total_relationship: 0,tag_list:["能力者"])
garp=luffy.hyles.create!(category: cate3,name: "ガープ",birthday: Date.parse("1942-5-2"),birthday_date:"0502",total_relationship: 10,tag_list:["家族"])
akainu=luffy.hyles.create!(category: cate3,name: "赤犬",birthday: Date.parse("1965-8-16"),birthday_date:"0816",total_relationship: 40,tag_list:["能力者","大将"])
kizaru=luffy.hyles.create!(category: cate3,name: "黄猿",birthday: Date.parse("1962-11-23"),birthday_date:"1123",total_relationship: 60,tag_list:["能力者","大将"])
fujitora=luffy.hyles.create!(category: cate3,name: "藤虎",birthday: Date.parse("1966-8-10"),birthday_date:"0810",total_relationship: 80,tag_list:["能力者","大将"])
#青キジ
aokiji=luffy.hyles.create!(category: cate5,name: "青雉",birthday: Date.parse("1973-9-21"),birthday_date:"0921",total_relationship: 30,tag_list:["能力者"])
#バギー海賊団
baggy=luffy.hyles.create!(category: cate2,name: "バギー",birthday: Date.parse("1981-8-8"),birthday_date:"0808",total_relationship: 90,tag_list:["王下七武海","能力者"])
albida=luffy.hyles.create!(category: cate2,name: "アルビダ",birthday: Date.parse("1993-3-14"),birthday_date:"0314",total_relationship: 0,tag_list:["能力者"])
...
shanks=luffy.hyles.create!(category: cate2,name: "シャンクス",birthday: Date.parse("1983-3-9"),birthday_date:"0309",total_relationship: 0,tag_list:["四皇"])
teech=luffy.hyles.create!(category: cate2,name: "マーシャル・D・ティーチ",birthday: Date.parse("1982-8-3"),birthday_date:"0803",total_relationship: 70,tag_list:["四皇","能力者"])
#和の国
kin=luffy.hyles.create!(category: cate5,name: "錦えもん",birthday: nil,total_relationship: 0,tag_list:["能力者"])
#人魚
kaimy=luffy.hyles.create!(category: cate6,name: "ケイミー",birthday: Date.parse("2002-11-3"),birthday_date:"1103",total_relationship: 0)
cobby=luffy.hyles.create!(category: cate3,name: "コビー",birthday: Date.parse("2002-5-13"),birthday_date:"0513",total_relationship: 0)
#海賊
roe=luffy.hyles.create!(category: cate2,name: "トラファルガー・ロー",birthday: Date.parse("1994-10-6"),birthday_date:"1006",total_relationship: 70,tag_list:["王下七武海","能力者","同盟","最悪の世代"])
hancok=luffy.hyles.create!(category: cate2,name: "ボア・ハンコック",birthday: nil,total_relationship: 10,tag_list:["王下七武海","能力者"])
kit=luffy.hyles.create!(category: cate2,name: "ユースタス・キッド",birthday: Date.parse("1997-1-10"),birthday_date:"0110",total_relationship: 0,tag_list:["能力者","最悪の世代"])
#ビビ
bibi=luffy.hyles.create!(category: cate6,name: "ビビ",birthday: Date.parse("2002-2-2"),birthday_date:"0202",total_relationship: 0)
#ドラゴン
