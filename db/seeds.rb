...
#麦わらの一味
zoro=luffy.hyles.create!(category: cate1,name: "ロロノア・ゾロ",birthday: Date.parse("1999-11-11"),birthday_date:"1111",total_relationship: 100,tag_list:["最悪の世代"])
nami=luffy.hyles.create!(category: cate1,name: "ナミ",birthday: Date.parse("2000-7-3"),birthday_date:"0703",total_relationship: 100)
usopp=luffy.hyles.create!(category: cate1,name: "ウソップ",birthday: Date.parse("1999-4-1"),birthday_date:"0401",total_relationship: 100)
sanji=luffy.hyles.create!(category: cate1,name: "ヴィンスモーク・サンジ",birthday: Date.parse("1999-3-2"),birthday_date:"0302",total_relationship: 100)
chopper=luffy.hyles.create!(category: cate1,name: "トニートニー・チョッパー",birthday: Date.parse("2003-12-24"),birthday_date:"1224",total_relationship: 100,tag_list:["能力者"])
robin=luffy.hyles.create!(category: cate1,name: "ニコ・ロビン",birthday: Date.parse("1990-2-6"),birthday_date:"0206",total_relationship: 100,tag_list:["能力者"])
franky=luffy.hyles.create!(category: cate1,name: "フランキー",birthday: Date.parse("1984-3-9"),birthday_date:"0309",total_relationship: 100)
brook=luffy.hyles.create!(category: cate1,name: "ブルック",birthday: Date.parse("1930-4-3"),birthday_date:"0403",total_relationship: 100,tag_list:["能力者"])
#ルフィの兄弟
ace=luffy.hyles.create!(category: cate2,name: "エース",birthday: Date.parse("1998-1-1"),birthday_date:"0101",total_relationship: 50,tag_list:["能力者","兄弟"])
sabo=luffy.hyles.create!(category: cate4,name: "サボ",birthday: Date.parse("1998-3-20"),birthday_date:"0320",total_relationship: 50,tag_list:["能力者","兄弟"])
#海軍
sengoku=luffy.hyles.create!(category: cate3,name: "センゴク",birthday: nil,total_relationship: 0,tag_list:["能力者"])
garp=luffy.hyles.create!(category: cate3,name: "ガープ",birthday: Date.parse("1942-5-2"),birthday_date:"0502",total_relationship: 0,tag_list:["家族"])
akainu=luffy.hyles.create!(category: cate3,name: "赤犬",birthday: Date.parse("1965-8-16"),birthday_date:"0816",total_relationship: 0,tag_list:["能力者","大将"])
kizaru=luffy.hyles.create!(category: cate3,name: "黄猿",birthday: Date.parse("1962-11-23"),birthday_date:"1123",total_relationship: 0,tag_list:["能力者","大将"])
fujitora=luffy.hyles.create!(category: cate3,name: "藤虎",birthday: Date.parse("1966-8-10"),birthday_date:"0810",total_relationship: 0,tag_list:["能力者","大将"])
#青キジ
aokiji=luffy.hyles.create!(category: cate5,name: "青雉",birthday: Date.parse("1973-9-21"),birthday_date:"0921",total_relationship: 0,tag_list:["能力者"])
#バギー海賊団
baggy=luffy.hyles.create!(category: cate2,name: "バギー",birthday: Date.parse("1981-8-8"),birthday_date:"0808",total_relationship: 0,tag_list:["王下七武海","能力者"])
